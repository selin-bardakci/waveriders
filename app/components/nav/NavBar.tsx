...
const NavBar = () => {
  ...
  const renderNavLinks = () => {
    ...
    if (account_type === 'customer') {
      return (
        <>
          <Link href="/auth/ListingsPage"   className="text-base font-medium py-2 px-4 hover:bg-gray-200 transition rounded-md">Rent a boat</Link>
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                <Link href="/Customer/customerDashboard" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  Dashboard
                </Link>
                <Link href="/Favourites" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  Favourites
                </Link>
                <Link href="/RecentActivities" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  Recent Activities
                </Link>
                <button
      ...
      return (
        <>
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                <Link href="/Business/businessDashboard" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  Dashboard
                </Link>
                <Link href="/Favourites" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  Favourites
                ...
                <Link href="/Business/allListings" className="block px-4 py-2 hover:bg-gray-100" onClick={closeDropdown}>
                  My Listings
                </Link>
                <button
                  className="block w-full text-left px-4 py-2 hover:bg-gray-100"
